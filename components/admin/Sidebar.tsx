...
const Sidebar = () => {
  ...
  return (
    <aside className="flex justify-between fixed h-screen flex-col bg-[#faf7f5] max-w-[300px] items-center w-full py-6">
      <div>
      ...
      <div className="flex items-center space-x-5">
        <div className="w-10 h-10 grid place-items-center bg-black text-white rounded-full">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
